...
def parse_args():
    ...
    parser.add_argument('--embed_size', type=int, default=128,
                        help='Embedding size.')
    parser.add_argument('--layer_size', nargs='?', default='[48,48,48]',
    ...
    parser.add_argument('--node_dropout', nargs='?', default='[0.9]',
                        help='Keep probability w.r.t. node dropout (i.e., 1-dropout_ratio) for each deep layer. 1: no dropout.')
    parser.add_argument('--mess_dropout', nargs='?', default='[0.9,0.9,0.9]',
